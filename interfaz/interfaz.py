...
class Ui_interfaz(object):
    def setupUi(self, interfaz, data):
        ...
        #Sliders
        #self.horizontalSlider = QtWidgets.QSlider(interfaz)
        #self.horizontalSlider.setGeometry(QtCore.QRect(160, 680, 800, 22))
        #self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        #self.horizontalSlider.setSliderPosition(50)
        #self.horizontalSlider.setTracking(True)
        #self.horizontalSlider.setObjectName("horizontalSlider")
        
        #self.verticalSlider = QtWidgets.QSlider(interfaz)
        #self.verticalSlider.setGeometry(QtCore.QRect(970, 55, 22, 600))
        ...
        #Panorama Name
        #self.nameLabel = QtWidgets.QLabel(interfaz)
        #self.nameLabel.setGeometry(QtCore.QRect(10, 10, 220, 16))
        #self.nameLabel.setObjectName("nameLabel")
        
        #self.nombreMuestra = QtWidgets.QLineEdit(interfaz)
        #self.nombreMuestra.setGeometry(QtCore.QRect(10, 30, 300, 21))
        #self.nombreMuestra.setObjectName("nombreMuestra")
        ...
        #New Panorama
        #self.newPanorama = QtWidgets.QPushButton(interfaz)
        #self.newPanorama.setGeometry(QtCore.QRect(340, 30, 76, 22))
        #self.newPanorama.setObjectName("newPanorama")
               
        #previewMuestra
        #self.previewMuestra = QtWidgets.QGraphicsView(interfaz)
        #self.previewMuestra.setGeometry(QtCore.QRect(160, 60, 500, 500))
        #self.previewMuestra.setObjectName("previewMuestra")
        
#       Frame
#         self.frame = QtWidgets.QFrame(interfaz)
#         self.frame.setGeometry(QtCore.QRect(10, 60, 140, 230))
#         self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
#         self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
#         self.frame.setObjectName("frame")
        
        #PanoramaList
        #self.panoramasLabel = QtWidgets.QLabel(self.frame)
        #self.panoramasLabel.setGeometry(QtCore.QRect(10, 10, 110, 22))
        #self.panoramasLabel.setObjectName("panoramasLabel")
        
        #self.panoramasList = QtWidgets.QComboBox(self.frame)
        #self.panoramasList.setGeometry(QtCore.QRect(10, 35, 110, 22))
        #self.panoramasList.setMaxVisibleItems(99)
        #self.panoramasList.setObjectName("panoramasList")
        #self.panoramasList.addItem("")
        
        #Images
        #self.imagenesLabel = QtWidgets.QLabel(self.frame)
        #self.imagenesLabel.setGeometry(QtCore.QRect(20, 60, 91, 22))
        #self.imagenesLabel.setObjectName("imagenesLabel")
        
        #self.imagenesList = QtWidgets.QComboBox(self.frame)
        #self.imagenesList.setGeometry(QtCore.QRect(30, 82, 91, 22))
        #self.imagenesList.setMaxVisibleItems(99)
        #self.imagenesList.setObjectName("imagenesList")
        #self.imagenesList.addItem("")
        
        #Obtain
        #self.obtainImg = QtWidgets.QPushButton(self.frame)
        #self.obtainImg.setGeometry(QtCore.QRect(30, 110, 91, 25)) 
        #self.obtainImg.setObjectName("obtainImg")
        #Add
        #self.addImg = QtWidgets.QPushButton(self.frame)
        #self.addImg.setGeometry(QtCore.QRect(30, 135, 91, 25)) 
        #self.addImg.setObjectName("addImg")
        #Remove
        #self.removeImg = QtWidgets.QPushButton(self.frame)
        #self.removeImg.setGeometry(QtCore.QRect(30, 160, 91, 25))
        #self.removeImg.setObjectName("removeImg")
                
        #STITCH
        #self.stitch = QtWidgets.QPushButton(self.frame)
        #self.stitch.setGeometry(QtCore.QRect(30, 195, 91, 21)) 
        #self.stitch.setObjectName("stitch")
    ...
    def retranslateUi(self, interfaz):
        ...
        #self.nameLabel.setText(_translate("CaptuRing", "Name of the Panorama"))
        self.nameCoreL.setText(_translate("CaptuRing", "Sample Name"))
        #self.stitch.setText(_translate("CaptuRing", "STITCH"))
        #self.panoramasList.setItemText(0, _translate("CaptuRing", "None"))
        #self.newPanorama.setText(_translate("CaptuRing", "NewP"))
        self.newcoreName.setText(_translate("CaptuRing", "Name It!"))
        #self.panoramasLabel.setText(_translate("CaptuRing", "Panoramas"))
        #self.obtainImg.setText(_translate("CaptuRing", "Obtain"))
        #self.addImg.setText(_translate("CaptuRing", "Add"))
        #self.imagenesLabel.setText(_translate("CaptuRing", "Images"))
        #self.imagenesList.setItemText(0, _translate("CaptuRing", "Images"))
        #self.removeImg.setText(_translate("CaptuRing", "Remove"))
        self.sampleSizeLabel.setText(_translate("CaptuRing", "Sample size (mm)"))
